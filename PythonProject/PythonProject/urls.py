...
urlpatterns = [
    ...
    url(r'^Product/', include('apps.Product.urls', namespace='Product')),  # 商品模块
    url(r'^PriceRegion/', include('apps.PriceRegion.urls', namespace='PriceRegion')),  # 价格区间模块
    url(r'^OldLevel/', include('apps.OldLevel.urls', namespace='OldLevel')),  # 新旧程度模块
    url(r'^AreaInfo/', include('apps.AreaInfo.urls', namespace='AreaInfo')),  # 所在区域模块
